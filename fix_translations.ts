...
// Remove the incorrectly added keys at the end
...
for (const lang of langs) {
  // Find the end of the language object, which is right before the next language or the end of the translations object
