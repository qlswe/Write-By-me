export const translations = {
  ru: {
    ...
    homeTitle: "Добро пожаловать в Базу Данных: Министерство Ахахи!",
  ...
  en: {
    ...
    homeTitle: "Welcome to the Database: Ministry of Ahaha!",
  ...
  by: {
    ...
    homeTitle: "Сардэчна запрашаем у Базу дадзеных: Міністэрства Ахахі!",
  ...
  de: {
    siteName: "Ministerium von Ahaha",
    navHome: "Startseite",
    ...
    homeTitle: "Willkommen in der Wissensdatenbank: Ministerium von Ahaha!",
  ...
  fr: {
    ...
    navTierList: "Tier List",
    homeTitle: "Bienvenue dans la base de connaissances : Ministère d'Ahaha !",
