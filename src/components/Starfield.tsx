...
export const Starfield: React.FC<StarfieldProps> = ({ lowPerfMode }) => {
  ...
  return (
    <div className="fixed inset-0 -z-10 bg-[#1A1230] overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#C3A6E6]/10 rounded-full blur-[100px] transform-gpu" />
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#5C4B8B]/20 rounded-full blur-[100px] transform-gpu" />
