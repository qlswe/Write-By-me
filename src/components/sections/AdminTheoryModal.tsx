    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
        <motion.div
          ...
          className="bg-[#2F244F] border border-[#5C4B8B] rounded-2xl shadow-2xl w-full max-w-5xl max-h-[90vh] flex flex-col overflow-hidden"
        >
          <div className="flex items-center justify-between p-4 border-b border-[#5C4B8B] bg-[#3E3160] shrink-0">
            <h3 className="text-xl font-bold text-white">
              {theoryToEdit ? 'Редактировать запись' : 'Создать запись'}
            </h3>
            <button onClick={onClose} className="p-2 text-gray-400 hover:text-white rounded-full hover:bg-[#5C4B8B] transition-colors">
              <X size={20} />
            </button>
          </div>
          ...
          <div className="p-6 overflow-y-auto flex-1 min-h-0 space-y-6">
            <div className="flex justify-end mb-2">
              <button
                ...
                className="flex items-center gap-2 bg-[#5C4B8B] text-white px-3 py-1.5 rounded-lg text-sm hover:bg-[#C3A6E6] hover:text-[#1A1230] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <Languages size={16} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <h4 className="text-[#C3A6E6] font-bold border-b border-[#5C4B8B] pb-2">Russian (RU)</h4>
                ...
                <div>
                  ...
                  <input 
                    ...
                    className="w-full bg-[#1A1230] border border-[#5C4B8B] rounded-lg p-2 text-white focus:outline-none focus:border-[#C3A6E6]"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    className="w-full bg-[#1A1230] border border-[#5C4B8B] rounded-lg p-2 text-white focus:outline-none focus:border-[#C3A6E6] h-24 resize-none"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    className="w-full bg-[#1A1230] border border-[#5C4B8B] rounded-lg p-2 text-white focus:outline-none focus:border-[#C3A6E6] h-64 font-mono text-sm"
              ...
              <div className="space-y-4">
                <h4 className="text-[#C3A6E6] font-bold border-b border-[#5C4B8B] pb-2">English (EN)</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-[#5C4B8B]">
              <div>
          ...
          <div className="p-4 border-t border-[#5C4B8B] bg-[#3E3160] shrink-0 flex justify-end gap-3">
            <button 
              onClick={onClose}
              className="px-4 py-2 rounded-lg text-gray-300 hover:text-white hover:bg-[#5C4B8B] transition-colors"
            >
              Отмена
            </button>
            <button 
              ...
              className="px-4 py-2 rounded-lg bg-[#C3A6E6] text-[#1A1230] font-bold hover:bg-white transition-colors flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <Save size={18} />
